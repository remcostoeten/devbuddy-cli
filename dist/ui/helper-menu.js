...
const helpTopics = [
    ...
    },
    {
        ...
        content: "To add a new plugin, create a new file in the `src/plugins` directory and implement the Plugin interface.",
    },
    // Add more help topics here
];
export async function showHelperMenu(plugins) {
    while (true) {
